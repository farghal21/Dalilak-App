            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const HistoryAppBar(title: AppStrings.compareCarsTitle),
                    ...
                    children: [
                      ...
                      SpecsSection(
                        ...
                        specs: [
                          ...
                          _buildRow('العزم', leftCar, rightCar,
                              (specs) => specs.torque),
                          ...
                          _buildRow('تيربو', leftCar, rightCar,
                              (specs) => specs.turbo),
                      ...
                      SpecsSection(
                        ...
                        specs: [
                          ...
                          _buildRow('عدد المقاعد', leftCar, rightCar,
                              (specs) => specs.seats),
                          _buildRow('الطول', leftCar, rightCar,
                              (specs) => specs.length),
                          _buildRow('العرض', leftCar, rightCar,
                              (specs) => specs.width),
